...
//
// OAUTH_CLIENT_ID: create a "Web application" OAuth client in Google Cloud
// Console (NOT a "Chrome extension" client — those only work with
// chrome.identity.getAuthToken, which Brave and Edge do not support).
// Add this authorized redirect URI to it:
//
...
export function isClientIdConfigured() {
  return !OAUTH_CLIENT_ID.startsWith("YOUR_");
}
